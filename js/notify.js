                  ...
                  <div class="notifications__item__content">
                      ...
                      <div class="notifications__item__content__bottom">
                          ...
                          <div class="notifications__item__icons">
                              <img src="./img/notifications/notification-ok.png" alt="">
                          </div>
                      </div>
                  </div>
                  <div class="notifications__item__btn">
                      <img class="notifications__item__btn-close" src="./img/notifications/notifications-close.png" height="15px" width="15px" alt="">
                  </div>
                `;
...
const data = [
    {
        ...
        desc: "Has just bought the pink duo!",
        img: "./img/slider/pink/pink_4.webp",
        time: "15 sec",
    },
    {
        name: "Solaina La****",
        address: "Manchester, England",
        desc: "Has just bought the coral duo.",
        img: "./img/slider/coral/coral_4.webp",
        time: "25 sec",
    },
];
